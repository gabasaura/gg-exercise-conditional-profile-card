...
function render(variables = {}) {
  ...
  if (variables.name === null || variables.lastName === null) {
    if (variables.name === null) variables.name = "JUANA";
    if (variables.lastName === null) variables.lastName = "DE ARCO";
  }
  let fullName = `<h1>${variables.name} ${variables.lastName}</h1>`;
  if (variables.role === null) variables.role = `<h2>HEROINA Y SANTA</h2>`;
  if (variables.city === null || variables.country === null) {
    if (variables.city === null) variables.city = "DÒMREMY";
    if (variables.country === null) variables.country = "FRANCIA";
  }
